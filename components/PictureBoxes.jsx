        ...
        <div className='px-6 my-30 max-w-6xl mx-auto'>
            <div className='flex flex-col md:flex-row gap-6 justify-between'>
                <div className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text flex-1">
                    <div className='bg-gradient-to-br from-slate-100 to-slate-200 rounded-3xl p-8 h-64 flex items-center justify-between relative overflow-hidden'>
                        <div className='text-left z-10 flex-1'>
                            ...
                            <button className='bg-gradient-to-r from-slate-600 to-slate-700 text-white px-6 py-2 rounded-full hover:from-slate-700 hover:to-slate-800 transition'>
                                Shop Now
                            </button>
                        </div>
                ...
                <div className="text-box banner-layer x50 md-x50 lg-x50 y50 md-y50 lg-y50 res-text flex-1">
                    <div className='bg-gradient-to-br from-slate-200 to-slate-300 rounded-3xl p-8 h-64 flex items-center justify-between relative overflow-hidden'>
                        <div className='text-left z-10 flex-1'>
